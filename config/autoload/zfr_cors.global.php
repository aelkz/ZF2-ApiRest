...
return array(
    'zfr_cors' => array(
          ...
          */
         'allowed_methods' => array('GET', 'POST', 'PUT', 'DELETE', 'OPTIONS', 'OPTION'),
         
         /**
          * Set the list of headers. This is returned in the preflight request to indicate
          * which HTTP headers can be used when making the actual request
          */
         'allowed_headers' => array('Access-Control-Allow-Methods', 'Origin', 'User-Agent', 'Host', 'X-Requested-With', 'Connection', 'Accept-Language', 'Content-Type', 'Accept-Encoding', 'Accept', 'Authorization', 'Access-Control-Allow-Headers', 'Access-Control-Request-Method', 'Access-Control-Allow-Origin','X-Authentication','Authentication'),
